...
const DEFAULT_AVATAR =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIyUAZwjVzqpQBqBREJUtZWs2_Vk_AgOJZ6Q&s";
...
export default function AvatarDropdown() {
  ...
  const avatarUrl =
    user?.avatar || localStorage.getItem("user_avatar") || DEFAULT_AVATAR;
  ...
  return (
    <div className="avatar-dropdown-container" ref={dropdownRef}>
      ...
      <button
        ...
        aria-haspopup="true"
      >
        <div className="avatar avatar-with-crown">
          <img src={avatarUrl} alt="User Avatar" className="avatar-image"></img>
          {user?.premium && (
            <Crown
              size={16}
              className="avatar-crown-icon"
              color="#facc15"
              title="Premium user"
            />
          )}
